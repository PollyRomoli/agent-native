export { default } from "@agentnative-fork/dispatch/routes/pages/overview";
import type { LoaderFunctionArgs } from "react-router";
import {
  buildThreadLinkPreviewMeta,
  type ThreadLinkPreview,
} from "@agentnative-fork/dispatch/lib/thread-link-preview";
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const { loadThreadLinkPreview } =
    await import("@agentnative-fork/dispatch/server/lib/thread-link-preview");
  return {
