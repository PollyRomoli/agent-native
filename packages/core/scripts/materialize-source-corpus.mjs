...
function writeCorpusReadme(stats) {
  const lines = [
    ...
    "",
    "This directory is generated when `@agentnative-fork/core` is built for npm.",
    "It gives coding agents a version-matched, searchable reference corpus",
    "inside installed apps at `node_modules/@agentnative-fork/core/corpus`.",
    "",
    "## Contents",
    "",
    "- `core/` -- source and package files for `@agentnative-fork/core`.",
