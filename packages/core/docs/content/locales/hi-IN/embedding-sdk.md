...
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| **एंबेडेडऐप पिकर**              | एक केंद्रित आईफ्रेम (एसेट पिकर, फॉर्म बिल्डर, अनुमोदन पैनल) के रूप में एक पूर्ण Agent-Native ऐप लॉन्च करना।                  | `@agentnative-fork/embedding`                   |
| **`<AgentNative>` होस्ट ब्रिज** | स्टैंडअलोन साइडकार ऐप्स या क्रॉस-ओरिजिन आईफ्रेम जो पेज संदर्भ और क्लाइंट actions को मैन्युअल रूप से वायर करते हैं।           | `@agentnative-fork/core/client`                 |
| **पोर्टेबल एक्सटेंशन**          | जब SaaS के पास पहले से ही एक्सटेंशन स्टोरेज/अनुमोदन हो तो होस्ट उपयोगकर्ताओं को सैंडबॉक्स वाले मिनी-ऐप बनाने की अनुमति देना। | `@agentnative-fork/core/client` एक्सटेंशन स्लॉट |

निचले स्तर का `@agentnative-fork/embedding` पैकेज उजागर करता है:

| आयात पथ                            | यह क्या प्रदान करता है                                                                        |
| ---------------------------------- | --------------------------------------------------------------------------------------------- |
| `@agentnative-fork/embedding`          | `EmbeddedApp` पिकर घटक, `getA2AUrl`, `getMcpUrl`, `sendMessage` (स्ट्रीमिंग A2A)              |
| `@agentnative-fork/embedding/react`    | React-विशिष्ट हुक और घटक                                                                      |
| `@agentnative-fork/embedding/bridge`   | `announceEmbeddedAppReady`, `sendEmbeddedAppMessage` - एम्बेडेड ऐप के अंदर उपयोग किया जाता है |
| `@agentnative-fork/embedding/agent`    | एजेंट एंडपॉइंट हेल्पर्स                                                                       |
| `@agentnative-fork/embedding/protocol` | प्रोटोकॉल प्रकार                                                                              |
...
जब होस्ट उत्पाद पूर्ण लॉन्च करना चाहता है तो `@agentnative-fork/embedding` का उपयोग करें
