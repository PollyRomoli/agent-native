...
दो हुक, दोनों `@agentnative-fork/core/client` में। प्रकार का अनुमान आपके `defineAction` स्कीमा से लगाया जाता है - कोई मैन्युअल प्रकार की घोषणा नहीं।
...
`@agentnative-fork/core/data-widgets`. [Native Chat UI](/docs/native-chat-ui)
