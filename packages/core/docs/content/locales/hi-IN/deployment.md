...
प्रदाता बिल्ड कमांड को कॉन्फ़िगर करते समय, `--build-only` के साथ उसी कमांड का उपयोग करें। वर्सेल को `npx @agentnative-fork/core@latest deploy --preset vercel --build-only` चलाना चाहिए; कमांड सीधे `.vercel/output` लिखता है, इसलिए कार्यक्षेत्र रूटिंग के लिए कोई `vercel.json` आवश्यक नहीं है।
...
प्रति-ऐप स्वतंत्र तैनाती अभी भी समर्थित है - बस एक स्टैंडअलोन मचान की तरह `cd apps/<name> && npx @agentnative-fork/core@latest build`।

## यह कैसे काम करता है {#how-it-works}

जब आप `npx @agentnative-fork/core@latest build` चलाते हैं, तो Nitro क्लाइंट SPA और सर्वर API दोनों को `.output/` में बनाता है:
...
| `APP_BASE_PATH`             | एप्लिकेशन को किसी उपसर्ग के अंतर्गत माउंट करें (उदा. `/mail`)। `npx @agentnative-fork/core@latest deploy` द्वारा स्वचालित रूप से सेट करें; स्टैंडअलोन के लिए अनसेट छोड़ दें। |
