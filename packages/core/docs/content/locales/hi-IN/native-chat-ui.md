...
`@agentnative-fork/core/data-widgets`; क्लाइंट कोड
`@agentnative-fork/core/client/chat` या `@agentnative-fork/core/client`.
...
सभी कनेक्टर `@agentnative-fork/core/client/chat` (और रूट
`@agentnative-fork/core/client` प्रविष्टि)। जब आपका एजेंट
