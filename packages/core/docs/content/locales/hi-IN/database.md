...
प्रत्येक टेम्पलेट `@agentnative-fork/core/db` से `createGetDb(schema)` को कॉल करके एक आलसी, सिंगलटन Drizzle क्लाइंट बनाता है। विहित स्थान `server/db/index.ts` है:
...
`@agentnative-fork/core/db/schema` से फ्रेमवर्क के स्कीमा हेल्पर्स का उपयोग करें:
...
कभी भी सीधे `drizzle-orm/sqlite-core` या `drizzle-orm/pg-core` से आयात न करें। हमेशा `@agentnative-fork/core/db/schema` का उपयोग करें।
