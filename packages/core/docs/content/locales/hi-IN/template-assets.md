...
1. **एक बार इंस्टॉल करें।** यह कौशल निर्देश जोड़ता है और होस्टेड MCP कनेक्टर को एक साथ पंजीकृत करता है:
   ...
   ```बैश
   npx @agentnative-fork/core@latest skills संपत्ति जोड़ें # उपनाम: छवि-पीढ़ी
   ```
