...
`@agentnative-fork/core/client/i18n` रनटाइम। फ़्रेमवर्क उपयोगकर्ता को संग्रहीत करता है
...
`@agentnative-fork/core/server` से `resolveLocaleFromRequest()` को कॉल करें और पास करें
