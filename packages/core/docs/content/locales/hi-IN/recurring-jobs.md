...
आवर्ती नौकरियों को `@agentnative-fork/scheduling` के साथ भ्रमित न करें:
...
- **`@agentnative-fork/scheduling`** - कैलेंडर/बुकिंग सुविधाओं (इवेंट प्रकार, उपलब्धता विंडो, बुकिंग) के निर्माण के लिए एक पुन: प्रयोज्य डोमेन पैकेज। `calendar` टेम्पलेट और कस्टम शेड्यूलिंग सतहों को शक्ति प्रदान करता है।
