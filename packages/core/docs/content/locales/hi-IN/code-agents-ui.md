...
Agent-Native कोड Agent-Native कोडिंग सतह है: कोडिंग सत्र, स्लैश कमांड, माइग्रेशन, ऑडिट, ट्रांसक्रिप्ट, रन नियंत्रण और फॉलो-अप के लिए एक स्थानीय Claude कोड/Codex-शैली कार्यक्षेत्र। एक खाली `npx @agentnative-fork/core@latest` कमांड इस कार्यक्षेत्र को खोलता है; `npx @agentnative-fork/core@latest code` उसी अनुभव के लिए स्पष्ट उपकमांड है।

तीन परतें हैं:

- **CLI**: `npx @agentnative-fork/core@latest` और `npx @agentnative-fork/core@latest code` रन शुरू करें, फिर से शुरू करें, निरीक्षण करें और रोकें।
- **डेस्कटॉप**: बाईं ओर का कोड टैब समान रन मॉडल का उपयोग करते हुए मूल टर्मिनल लॉन्च, ऐप वेबव्यू और डेस्कटॉप डीप लिंक जोड़ता है।
- **साझा UI**: `@agentnative-fork/code-agents-ui` पुन: प्रयोज्य React सतह प्रस्तुत करता है।
...
{
  "html": "<div class=\"diagram-layers\"><div class=\"diagram-row\"><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">CLI</span><small class=\"diagram-muted\">start · resume · status · stop</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill\">Desktop</span><small class=\"diagram-muted\">native terminal · webviews · deep links</small></div><div class=\"diagram-card\" data-rough><span class=\"diagram-pill accent\">साझा करेंd UI</span><small class=\"diagram-muted\">@agentnative-fork/code-agents-ui</small></div></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;</div><div class=\"diagram-panel center\" data-rough><span class=\"diagram-pill\">CodeAgentsHost</span><small class=\"diagram-muted\">host contract</small></div><div class=\"diagram-arrow diagram-muted\" aria-hidden=\"true\">&darr;</div><div class=\"diagram-box\" data-rough>File-backed run store + executor<br><small class=\"diagram-muted\">@agentnative-fork/core/code-agents</small></div></div>",
...
प्रत्येक व्यक्ति `@agentnative-fork/core/code-agents` को कॉल करता है, जो इसे उजागर करता है
...
जब आप स्पष्ट नामस्थान चाहते हैं तो `npx @agentnative-fork/core@latest code` का उपयोग करें। अंतर्निर्मित स्लैश
...
रीडिंग कोड पर `@agentnative-fork/core/code-agents` से बैकग्राउंड-रन एक्सपोर्ट
...
`TiptapComposer` स्टैक को `@agentnative-fork/core/client/composer` से
