...
वर्कफ़्लो लिखे जाने के बाद, कॉन्फ़िगर करने के लिए `npx @agentnative-fork/core@latest recap setup` चलाएँ
GitHub Actions रहस्य/चर जहां संभव हो और `npx @agentnative-fork/core@latest recap doctor`
