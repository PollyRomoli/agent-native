...
- **एम्बेडेड एजेंट पैनल** - `@agentnative-fork/core` से प्रत्येक ऐप के अंदर भेजा जाता है।
...
`@agentnative-fork/core` - इंस्टॉल करने के लिए कोई अलग पैकेज नहीं है - और वही है
विकास और उत्पादन में घटक।

- `@agentnative-fork/core/client` से `AgentPanel` के रूप में निर्यात किया गया, एक
...
`@agentnative-fork/core/client` से) PTY सर्वर द्वारा समर्थित। आप असली
...
ये `@agentnative-fork/core` के साथ आते हैं और आपका ऐप इनसे बात करने के लिए उपयोग करता है
