...
L'espace de travail généré relie le `@agentnative-fork/core` local et
Packages `@agentnative-fork/dispatch`, donc modifications apportées aux Core API, espace de travail Dispatch
