...
El espacio de trabajo generado vincula el `@agentnative-fork/core` local y
Paquetes `@agentnative-fork/dispatch`, por lo que se realizan cambios en Core API, espacio de trabajo de envío
