...
ida y vuelta (`isReconcileLeadClient` desde `@agentnative-fork/core/client`).
...
`@agentnative-fork/core/client` para generar colores de cursor y visualización consistentes
