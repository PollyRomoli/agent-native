...
Tiempo de ejecución `@agentnative-fork/core/client/i18n`. El marco almacena el usuario
...
llamar a `resolveLocaleFromRequest()` desde `@agentnative-fork/core/server` y pasar el
