...
لا تخلط بين المهام المتكررة و`@agentnative-fork/scheduling`:
...
- **`@agentnative-fork/scheduling`** — حزمة نطاق قابلة لإعادة الاستخدام لإنشاء ميزات التقويم/الحجز (أنواع الأحداث، ونوافذ التوفر، والحجوزات). لتشغيل قالب `calendar` وأسطح الجدولة المخصصة.
