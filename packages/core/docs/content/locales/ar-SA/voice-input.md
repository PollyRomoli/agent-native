...
لست بحاجة إلى استدعاء هذا مباشرة، فالملحن هو من يفعل ذلك. إذا كنت تقوم بإنشاء سطح إدخال مخصص، فأعد أولاً استخدام أجزاء العميل الملحن/الصوت المشتركة من `@agentnative-fork/core/client`. تعامل مع هذا المسار باعتباره حد النقل منخفض المستوى للمساعدين المخصصين الذين يحتاجون إلى إرسال صوت متعدد الأجزاء.
