...
`@agentnative-fork/core/client/chat` أو `@agentnative-fork/core/client`.
...
يتم تصدير كافة الموصلات من `@agentnative-fork/core/client/chat` (والجذر
إدخال `@agentnative-fork/core/client`). استخدم وقت التشغيل HTTP العام عندما يكون وكيلك
