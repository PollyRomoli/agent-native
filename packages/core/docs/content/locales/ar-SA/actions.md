...
خطافان، كلاهما في `@agentnative-fork/core/client`. يتم استنتاج الأنواع من مخططات `defineAction` الخاصة بك — لا توجد إعلانات يدوية عن النوع.
...
`@agentnative-fork/core/data-widgets`. See [Native Chat UI](/docs/native-chat-ui)
