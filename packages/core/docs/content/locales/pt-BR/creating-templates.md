...
O espaço de trabalho gerado vincula o `@agentnative-fork/core` local e
Pacotes `@agentnative-fork/dispatch`, portanto, mudanças nos Core APIs, espaço de trabalho Dispatch
