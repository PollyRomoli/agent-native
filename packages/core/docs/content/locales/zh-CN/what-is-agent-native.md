...
尚未准备好分叉整个模板？您还可以通过向已使用的编码代理添加**技能**来尝试代理原生 - 使用 `npx @agentnative-fork/core@latest skills add visual-plan` 安装计划技能。请参阅 [Skills Guide](/docs/skills-guide#app-backed-skills)。
