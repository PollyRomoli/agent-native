 ...
 *     `ActionRegistry` interface in `@agentnative-fork/core/client`, giving
...
const CORE_SHARING_ACTIONS: Array<{ name: string; specifier: string }> = [
  {
    name: "share-resource",
    specifier: "@agentnative-fork/core/sharing/actions/share-resource",
  },
  {
    name: "unshare-resource",
    specifier: "@agentnative-fork/core/sharing/actions/unshare-resource",
  },
  {
    name: "list-resource-shares",
    specifier: "@agentnative-fork/core/sharing/actions/list-resource-shares",
  },
  {
    name: "set-resource-visibility",
    specifier: "@agentnative-fork/core/sharing/actions/set-resource-visibility",
  },
  {
    name: "upload-image",
    specifier: "@agentnative-fork/core/file-upload/actions/upload-image",
  },
  {
    name: "context-manifest-get",
    specifier:
      "@agentnative-fork/core/agent/context-xray/actions/context-manifest-get",
  },
  {
    name: "context-pin",
    specifier: "@agentnative-fork/core/agent/context-xray/actions/context-pin",
  },
  {
    name: "context-evict",
    specifier: "@agentnative-fork/core/agent/context-xray/actions/context-evict",
  },
  {
    name: "context-restore",
    specifier: "@agentnative-fork/core/agent/context-xray/actions/context-restore",
  },
  {
    name: "context-report",
    specifier: "@agentnative-fork/core/agent/context-xray/actions/context-report",
  },
  {
    name: "get-localization-preference",
    specifier:
      "@agentnative-fork/core/localization/actions/get-localization-preference",
  },
  {
    name: "set-localization-preference",
    specifier:
      "@agentnative-fork/core/localization/actions/set-localization-preference",
  },
];
...
function generateActionArtifacts(
  ...
  const typesContent = `// AUTO-GENERATED by @agentnative-fork/core — do not edit manually.
...
declare module "@agentnative-fork/core/client" {
...
`;
  ...
  const registryContent = `// AUTO-GENERATED by @agentnative-fork/core — do not edit manually.
 ...
 *
 * Add to your Vite config (auto-included by `defineConfig` from `@agentnative-fork/core`):
 *
 * ```ts
 * import { actionTypesPlugin } from "@agentnative-fork/core/vite/action-types-plugin";
